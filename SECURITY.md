...
- Local code execution or sandboxing behavior (the Jesus coding agent intentionally does not have a sandbox)
...
- Reports requiring the ability to create, modify, delete, or replace files,
  ...
  user-controlled local state on the target machine. This includes `~/.jesus`,
  `~/.jesus/agent/models.json`, workspace files, `AGENTS.md`, skills, extensions,
