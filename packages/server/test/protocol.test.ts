import { encodeServerMessage, PROTOCOL_VERSION } from "@jesus/protocol";
import type { Api, AssistantMessage, Model, ToolCall, ToolResultMessage, UserMessage } from "@jesus/ai";
