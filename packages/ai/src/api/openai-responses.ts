...
// OpenAI Responses rejects max_output_tokens below 16: https://github.com/jesus-agent/jesus-agent/issues/6265
...
function createClient(
	...
	const compat = getCompat(model);
	const headers: ProviderHeaders = { "User-Agent": getJesusUserAgent(), ...model.headers };
