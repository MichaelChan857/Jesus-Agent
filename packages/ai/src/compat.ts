 ...
 *
 * Existing apps switch imports from "@jesus/ai" to
 * "@jesus/ai/compat" unchanged; new code uses `createModels()`
...
import { appMessagesApi } from "./api/pi-messages.lazy.ts";
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "@jesus/ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "@jesus/ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "@jesus/ai/providers/all" or `Models.getProviders()`. */
