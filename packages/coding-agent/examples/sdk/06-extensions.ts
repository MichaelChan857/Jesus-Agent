...
import { createAgentSession, DefaultResourceLoader, getAgentDir, SessionManager } from "@jesus/coding-agent";
...
export default function (jesus: ExtensionAPI) {
	...
	jesus.on("agent_end", async (event) => {
	...
	// Register a command
	jesus.registerCommand("mycommand", {
