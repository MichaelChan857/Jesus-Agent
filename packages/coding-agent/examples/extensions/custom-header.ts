 ...
 * (logo + keybinding hints) with a custom component showing the jesus mascot.
 */

import type { ExtensionAPI, Theme } from "@jesus/coding-agent";
import { VERSION } from "@jesus/coding-agent";

// --- PI MASCOT ---
// Based on pi_mascot.ts - the jesus agent character
...
export default function (jesus: ExtensionAPI) {
	...
	jesus.registerCommand("builtin-header", {
