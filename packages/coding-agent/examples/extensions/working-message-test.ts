 ...
 *
 * Usage:
 *   jesus --extension examples/extensions/working-message-test.ts
 *
 * Then send a few messages in interactive mode. The working message should
 * stay "Reasoning... (custom)" with a brown dot indicator every time the
 * loader appears, not revert to the default gray "Reasoning...".
 */

import type { ExtensionAPI } from "@jesus/coding-agent";

const CUSTOM_MESSAGE = "\x1b[38;2;155;86;63mReasoning... (custom)\x1b[39m";
