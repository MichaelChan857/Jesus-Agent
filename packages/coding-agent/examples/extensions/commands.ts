 ...
 * Commands Extension
 *
 * Demonstrates the jesus.getCommands() API by providing a /commands command
...
import type { ExtensionAPI, SlashCommandInfo } from "@jesus/coding-agent";

export default function commandsExtension(jesus: ExtensionAPI) {
	jesus.registerCommand("commands", {
