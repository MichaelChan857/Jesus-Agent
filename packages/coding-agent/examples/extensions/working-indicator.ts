 ...
 * working indicator shown while jesus is streaming a response.
 *
 * Usage:
 *   jesus --extension examples/extensions/working-indicator.ts
 *
 * Commands:
 ...
 *   /working-indicator reset     Restore jesus's default spinner
 */

import type { ExtensionAPI, ExtensionContext, WorkingIndicatorOptions } from "@jesus/coding-agent";
...
export default function (jesus: ExtensionAPI) {
	...
	jesus.registerCommand("working-indicator", {
