 ...
 *
 * Usage: jesus --extension ./examples/extensions/overlay-test.ts
 *
...
import { CURSOR_MARKER, type Focusable, matchesKey, visibleWidth } from "@jesus/tui";

export default function (jesus: ExtensionAPI) {
	jesus.registerCommand("overlay-test", {
