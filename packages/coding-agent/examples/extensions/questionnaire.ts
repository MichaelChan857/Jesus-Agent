...
import { Editor, type EditorTheme, Key, matchesKey, Text, visibleWidth, wrapTextWithAnsi } from "@jesus/tui";
...
export default function questionnaire(jesus: ExtensionAPI) {
	jesus.registerTool({
		name: "questionnaire",
		label: "Questionnaire",
		description:
