...
Play DOOM as an overlay in jesus. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
jesus --extension ./examples/extensions/doom-overlay
```
...
- [pi-doom](https://github.com/badlogic/pi-doom) for the original jesus integration
