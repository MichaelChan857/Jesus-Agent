 ...
 *
 * Usage: jesus --extension ./examples/extensions/overlay-qa-tests.ts
 *
 * Commands:
...
import type { ExtensionAPI, ExtensionCommandContext, Theme } from "@jesus/coding-agent";
import type { Component, OverlayAnchor, OverlayHandle, OverlayOptions, TUI } from "@jesus/tui";
import { Input, matchesKey, truncateToWidth, visibleWidth } from "@jesus/tui";
...
export default function (jesus: ExtensionAPI) {
	...
	jesus.registerCommand("overlay-animation", {
	...
	jesus.registerCommand("overlay-anchors", {
	...
	jesus.registerCommand("overlay-margins", {
	...
	jesus.registerCommand("overlay-stack", {
	...
	jesus.registerCommand("overlay-overflow", {
	...
	jesus.registerCommand("overlay-edge", {
	...
	jesus.registerCommand("overlay-percent", {
	...
	// Test maxHeight
	jesus.registerCommand("overlay-maxheight", {
	...
	jesus.registerCommand("overlay-sidepanel", {
	...
	jesus.registerCommand("overlay-toggle", {
	...
	jesus.registerCommand("overlay-passive", {
	...
	jesus.registerCommand("overlay-focus", {
	...
	jesus.registerCommand("overlay-streaming", {
