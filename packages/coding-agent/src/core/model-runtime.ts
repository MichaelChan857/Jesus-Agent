...
import * as builtinProviderCatalog from "@jesus/ai/providers/all";
import { getAgentDir, getEnvWithFallback } from "../config.ts";
...
export class ModelRuntime implements Models {
	...
	static async create(options: CreateModelRuntimeOptions = {}): Promise<ModelRuntime> {
		...
		const runtime = new ModelRuntime(
			...
			modelsStore,
			providers,
			getEnvWithFallback("JESUS_OFFLINE", "PI_OFFLINE") === undefined,
		);
