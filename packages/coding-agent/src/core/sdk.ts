...
import { Agent, type AgentMessage, setDefaultStreamFn, type ThinkingLevel } from "@jesus/agent-core";
import { clampThinkingLevel, type Message, type Model, streamSimple } from "@jesus/ai/compat";
...
export interface CreateAgentSessionOptions {
	...
	cwd?: string;
	/** Global config directory. Default: ~/.jesus/agent */
	agentDir?: string;
