...
import type { AgentTool } from "@jesus/agent-core";
import { Container, Text, truncateToWidth } from "@jesus/tui";
...
export interface BashToolOptions {
	...
	shellPath?: string;
	/** Expose current Jesus session metadata as PI_* environment variables. Default: true */
	exposeSessionEnvironment?: boolean;
