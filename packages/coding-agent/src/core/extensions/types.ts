...
export interface ExtensionUIContext {
	 ...
	 * extend `CustomEditor` from `@jesus/coding-agent` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "@jesus/coding-agent";
	 *
...
export interface BeforeAgentStartEvent {
	...
	systemPrompt: string;
	/** Structured options used to build the system prompt. Extensions can inspect this to understand what Jesus loaded without re-discovering resources. */
...
/** Fired when Jesus starts waiting on a blocking user-facing extension UI prompt. */
...
/** Fired when Jesus is no longer waiting on a blocking user-facing extension UI prompt. */
...
export interface ExtensionAPI {
	...
	/** Register a transformer for user and assistant Markdown before Jesus renders it in the interactive transcript. */
