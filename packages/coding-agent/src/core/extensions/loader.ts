...
import * as _bundledAgentCore from "@jesus/agent-core";
import type { Provider } from "@jesus/ai";
import * as _bundledAiCompat from "@jesus/ai/compat";
import * as _bundledAiOauth from "@jesus/ai/oauth";
import * as _bundledAiProviders from "@jesus/ai/providers/all";
import type { KeyId } from "@jesus/tui";
import * as _bundledTui from "@jesus/tui";
...
// avoiding a circular dependency. Extensions can import from @jesus/coding-agent.
import * as _bundledCodingAgent from "../../index.ts";
import { resolvePath } from "../../utils/paths.ts";
import { readAppManifest } from "../app-manifest.ts";
...
const VIRTUAL_MODULES: Record<string, unknown> = {
	...
	"@jesus/agent-core": _bundledAgentCore,
	"@jesus/tui": _bundledTui,
	// Extensions resolve the pi-ai root to the compat entrypoint (a strict
	// superset of the core entrypoint): existing extensions using the old
	// global API keep working at runtime until compat is removed.
	"@jesus/ai": _bundledAiCompat,
	"@jesus/ai/compat": _bundledAiCompat,
	"@jesus/ai/oauth": _bundledAiOauth,
	"@jesus/ai/providers/all": _bundledAiProviders,
	"@jesus/coding-agent": _bundledCodingAgent,
	"@mariozechner/pi-agent-core": _bundledAgentCore,
	"@mariozechner/pi-tui": _bundledTui,
	"@mariozechner/pi-ai": _bundledAiCompat,
	"@mariozechner/pi-ai/compat": _bundledAiCompat,
	"@mariozechner/pi-ai/oauth": _bundledAiOauth,
	"@mariozechner/pi-ai/providers/all": _bundledAiProviders,
	"@mariozechner/pi-coding-agent": _bundledCodingAgent,
};
...
function getAliases(): Record<string, string> {
	...
	const codingAgentEntry = packageIndex;
	const agentCoreEntry = resolveWorkspaceOrImport("agent/dist/index.js", "@jesus/agent-core");
	const tuiEntry = resolveWorkspaceOrImport("tui/dist/index.js", "@jesus/tui");
	// Extensions resolve the pi-ai root to the compat entrypoint (a strict
	// superset of the core entrypoint): existing extensions using the old
	// global API keep working at runtime until compat is removed.
	const aiCompatEntry = resolveWorkspaceOrImport("ai/dist/compat.js", "@jesus/ai/compat");
	const aiOauthEntry = resolveWorkspaceOrImport("ai/dist/oauth.js", "@jesus/ai/oauth");
	const aiProvidersEntry = resolveWorkspaceOrImport("ai/dist/providers/all.js", "@jesus/ai/providers/all");

	_aliases = {
		"@jesus/coding-agent": codingAgentEntry,
		"@jesus/agent-core": agentCoreEntry,
		"@jesus/tui": tuiEntry,
		"@jesus/ai/providers/all": aiProvidersEntry,
		"@jesus/ai/compat": aiCompatEntry,
		"@jesus/ai/oauth": aiOauthEntry,
		"@jesus/ai": aiCompatEntry,
		"@mariozechner/pi-coding-agent": codingAgentEntry,
		"@mariozechner/pi-agent-core": agentCoreEntry,
		"@mariozechner/pi-tui": tuiEntry,
		"@mariozechner/pi-ai/providers/all": aiProvidersEntry,
		"@mariozechner/pi-ai/compat": aiCompatEntry,
		"@mariozechner/pi-ai/oauth": aiOauthEntry,
		"@mariozechner/pi-ai": aiCompatEntry,
...
function resolveExtensionEntries(dir: string): string[] | null {
	...
	if (fs.existsSync(packageJsonPath)) {
		const manifest = readAppManifest(packageJsonPath);
