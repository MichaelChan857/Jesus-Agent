...
import { type ImageContent, type Message, type TextContent, type Usage, uuidv7 } from "@jesus/ai";
 ...
 * Encodes cwd into a safe directory name under ~/.jesus/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.jesus/agent/sessions/<encoded-cwd>/).
	 */
