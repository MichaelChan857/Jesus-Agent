...
const MIGRATION_GUIDE_URL =
	"https://github.com/jesus-agent/jesus-agent/blob/main/packages/coding-agent/CHANGELOG.md#extensions-migration";
const EXTENSIONS_DOC_URL =
	"https://github.com/jesus-agent/jesus-agent/blob/main/packages/coding-agent/docs/extensions.md";
 ...
 *
 * See: https://github.com/jesus-agent/jesus-agent/issues/320
 */
