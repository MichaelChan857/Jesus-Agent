...
${chalk.bold("Commands:")}
  ...
  ${APP_NAME} auth <command>            Print credentials, check provider readiness, or persist API keys
...
${chalk.bold("Examples:")}
  ...
  # Persist an API key for the openai provider (written to auth.json, mode 0600)
  ${APP_NAME} auth set openai sk-...

  # Remove a stored API key
  ${APP_NAME} auth unset openai
...
${chalk.bold("Environment Variables:")}
  ...
  PI_SHARE_VIEWER_URL              - Base URL for /share command (default: https://jesus.dev/session/)
