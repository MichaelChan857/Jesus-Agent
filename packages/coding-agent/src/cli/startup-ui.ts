import { ProcessTerminal, setCapabilityOverrides, setKeybindings, type TUI, TuiMainScreen } from "@jesus/tui";
 ...
 * - this is the official Jesus Agent distribution (not a fork/rebrand)
