...
import type { OAuthCredentials } from "@jesus/ai";
import { getModel, streamSimple } from "@jesus/ai/compat";
import { builtinProviders } from "@jesus/ai/providers/all";
...
const AUTH_PATH = join(homedir(), ".jesus", "agent", "auth.json");
...
export const PI_AGENT_DIR = join(homedir(), ".jesus", "agent");
