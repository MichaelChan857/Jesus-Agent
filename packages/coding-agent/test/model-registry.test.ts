...
import type { AnthropicMessagesCompat, Api, Context, Model, OpenAICompletionsCompat } from "@jesus/ai/compat";
import { getApiProvider, getSupportedThinkingLevels } from "@jesus/ai/compat";
