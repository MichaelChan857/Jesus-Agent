...
import type { AssistantMessage, Context, Model } from "@jesus/ai";
...
vi.mock("@jesus/ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@jesus/ai/compat")>();
	return {
		...actual,
