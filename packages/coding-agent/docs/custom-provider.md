...
Credentials are persisted in `~/.jesus/agent/auth.json`:
...
- [anthropic-messages.ts](https://github.com/jesus-agent/jesus-agent/blob/main/packages/ai/src/api/anthropic-messages.ts) - Anthropic Messages API
- [mistral-conversations.ts](https://github.com/jesus-agent/jesus-agent/blob/main/packages/ai/src/api/mistral-conversations.ts) - Mistral Conversations API
- [openai-completions.ts](https://github.com/jesus-agent/jesus-agent/blob/main/packages/ai/src/api/openai-completions.ts) - OpenAI Chat Completions
- [openai-responses.ts](https://github.com/jesus-agent/jesus-agent/blob/main/packages/ai/src/api/openai-responses.ts) - OpenAI Responses API
- [google-generative-ai.ts](https://github.com/jesus-agent/jesus-agent/blob/main/packages/ai/src/api/google-generative-ai.ts) - Google Generative AI
- [bedrock-converse-stream.ts](https://github.com/jesus-agent/jesus-agent/blob/main/packages/ai/src/api/bedrock-converse-stream.ts) - AWS Bedrock
...
Test your provider against the same test suites used by built-in providers. Copy and adapt these test files from [packages/ai/test/](https://github.com/jesus-agent/jesus-agent/tree/main/packages/ai/test):
