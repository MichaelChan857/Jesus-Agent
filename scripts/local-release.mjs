...
const packages = [
	{ directory: "packages/telemetry", name: "@jesus/telemetry" },
	{ directory: "packages/ai", name: "@jesus/ai" },
	{ directory: "packages/tui", name: "@jesus/tui" },
	{ directory: "packages/agent", name: "@jesus/agent-core" },
	{ directory: "packages/protocol", name: "@earendil-works/pi-protocol" },
	{ directory: "packages/client", name: "@earendil-works/pi-client" },
	{ directory: "packages/session-backends/sqlite-node", name: "@earendil-works/pi-session-backends-backend-sqlite-node" },
	{ directory: "packages/server", name: "@earendil-works/pi-server" },
	{ directory: "packages/coding-agent", name: "@jesus/coding-agent" },
];
