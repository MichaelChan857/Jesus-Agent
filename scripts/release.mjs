 ...
 * 10. Push main and the tag to trigger CI publication and verified jesus.dev announcement
 */
...
console.log(`=== Prepared release v${version}; CI publication and jesus.dev announcement start after the tag push ===`);
