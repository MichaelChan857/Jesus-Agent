...
Attribution:
- Internal: `Fixed foo ([#123](https://github.com/jesus-agent/jesus-agent/issues/123))`
- External: `Added bar ([#456](https://github.com/jesus-agent/jesus-agent/pull/456) by [@user](https://github.com/user))`
